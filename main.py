...
database = load_module('database', os.path.join(script_dir, 'database..py'))
scraper = load_module('scraper', os.path.join(script_dir, 'scraper..py'))
upi_qr = load_module('upi_qr', os.path.join(script_dir, 'upi_qr..py'))
